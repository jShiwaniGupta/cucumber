...
public class CucumberApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(CucumberApp.class);

    private final Environment env;

    public CucumberApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CucumberApp.class);
